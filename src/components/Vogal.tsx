...
const Vogal: FC = () => {
	...
	useEffect(() => {
		if (!project) return
		console.groupCollapsed(`${project.name}' assistente de IA é feito por Vogal`)
		console.log(`__
/  \\
|  |    Widget permite adicionar uma IA de conversação
@  @      assistente de sua documentação em minutos.
|  |
|| |/
...
\\___/
	...
	const toggleOpen = useCallback(() => {
		if (state != WidgetState.Splash) reset()
